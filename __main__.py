...
buttons = [
    [
        InlineKeyboardButton(
            text="Add to your Group➕", url="t.me/ShokoGbot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(text="Advanced⭐️", callback_data="aboutmanu_"),
        InlineKeyboardButton(
            text="Support🌐", url=f"https://t.me/ShokoSupports"
        ),
    ],
    [
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text="*Shoko is a bot for managing your group with additional features,*"
                 ...
                 "\n\nIf any question about Shoko, let us know at @Shokosupports.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            text="*Basic help:*"
                 "\nTo add Shoko to your chats, simply click [here](http://t.me/ShokoGBot?startgroup=true)  and select your chat."
                 "\nYou can also click on @ShokoGBot, and go to the three dots on the top right of your screen, and select 'add to group'."
                 "",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[
        ...
        query.message.edit_text(
            text="<b>Terms and Conditions:</b>"
                 ...
                 "\nFollow @darkkinginfoabout to get info about bots.",
            parse_mode=ParseMode.HTML,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Support",
                            url=f"telegram.me/shokosupports",
                        ),
                        InlineKeyboardButton(
                           text="Channel",
                           url=f"telegram.me/Shokoupdates",
                        )
                    ],
                    [
                        InlineKeyboardButton(
